import { DOMWidgetView, ViewList, JupyterPhosphorWidget } from '@jupyter-widgets/base';
...
export declare class AccordionView extends DOMWidgetView {
     ...
     */
    add_child_view(model: any, index: any): Promise<DOMWidgetView>;
    remove(): void;
...
export declare class TabView extends DOMWidgetView {
     ...
     * Called when a child is added to children list.
     */
    addChildView(model: any, index: any): Promise<DOMWidgetView>;
    /**
