...
function Card(kernel, item, launcher, commands, launcherCallback) {
    ...
    return (React.createElement("div", { className: "jp-LauncherCard", title: title, onClick: onclick, "data-category": item.category || 'Other', key: Private.keyProperty.get(item) },
        ...
        React.createElement("div", { className: "jp-LauncherCard-label", title: title }, label)));
}
/**
